...
import { createCollector, decideBinding, decideWhatsappRecommendation, getArchiveChats, getArchiveMessages, getInsightEvidence, getIssueChats, getIssueSummary, getIssues, getLatestWhatsappScan, getPendingBindings, getWhatsappAccounts, getWhatsappInsights, requestWhatsappScan, type ArchiveChat, type ArchiveMessage, type BindingCandidate, type CollectionIssue, type CollectorCredential, type InsightEvidence, type IssueChat, type IssueSummary, type ScanJob, type WhatsappAccount, type WhatsappInsight } from '@/api/whatsapp'
