...
| BE-1052 | V42 至新版本迁移与 NAS 发布门禁 | ⏳ 进行中（执行人：Codex） | 2026-09-10 已对 NAS V42 生产副本完成 145 单 V42→V58 迁移/幂等重放，0 人工核对，数量与金额对账一致，生产未写入。发布工具已补齐不可变镜像、备份、维护页、迁移及 SQL 门禁，并改为 NAS TLS 密钥只读挂载。仍待可信外网 TLS、最终 release commit 重生预演证据及用户批准维护窗口 |
