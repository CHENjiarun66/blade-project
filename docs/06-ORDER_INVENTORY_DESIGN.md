...
> 当前实现说明：本文记录现有订单库存软解耦流程。2026-08-29 已确认下一版订单状态、收款流水、履约方式和旧数据迁移方案，详见 [14-ORDER_LIFECYCLE_REFACTOR_DESIGN.md](./14-ORDER_LIFECYCLE_REFACTOR_DESIGN.md)。新方案尚未实施，开发时不得直接把本文旧 `status=0-8` 数值改成新含义。
